...
```
git clone https://github.com/JEFFTheDev/pulsar-client-go.git
cd pulsar-client-go
...
https://github.com/JEFFTheDev/pulsar-client-go/milestone/1?closed=1
...
Add the release note to [Pulsar Client Go](https://github.com/JEFFTheDev/pulsar-client-go/releases)
...
https://github.com/JEFFTheDev/pulsar-client-go/releases/tag/v0.x.0

Release Notes are at:
https://github.com/JEFFTheDev/pulsar-client-go/blob/master/CHANGELOG.md
